...
node scripts/docker.mjs build 0.1.6
...
La versión completa `0.1.6` se publica en GHCR. Para instalarla sin construir la aplicación:

```powershell
node scripts/docker.mjs prepare
node scripts/docker.mjs pull 0.1.6 --registry
