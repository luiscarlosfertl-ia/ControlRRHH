...
node scripts/docker.mjs build 0.1.8
...
La versión completa `0.1.8` se publica en GHCR. Para instalarla sin construir la aplicación:

```powershell
node scripts/docker.mjs prepare
node scripts/docker.mjs pull 0.1.8 --registry
